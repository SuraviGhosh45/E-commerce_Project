        ...
        <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8 sm:py-12 lg:px-10 xl:px-12">
          ...
          <div className="mt-6">
            ...
            <p className="mt-3 max-w-xl text-sm leading-7 text-gray-500 sm:text-base">
              Manage your account information and view your Vendora profile.
            </p>
          ...
          <div className="space-y-6">
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-[#292929] bg-[#0B0B0B] py-3.5 pl-11 pr-4 text-sm text-white outline-none transition placeholder:text-gray-600 focus:border-[#C9A227]"
                      />
                  ...
                  <div className="flex flex-col-reverse gap-3 border-t border-[#292929] pt-5 sm:flex-row sm:justify-end">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 rounded-xl border border-[#292929] px-5 py-3.5 text-sm font-medium text-gray-300 transition hover:border-gray-500"
                    >
                      <FiX size={16} />
                      Cancel
                    </button>
            ...
            <section className="rounded-2xl border border-[#292929] bg-[#151515] p-5 sm:p-7">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500">
                Password management and other account-security features will
